...
import time
import pyautogui
from utils_adb import get_game_page_coords, get_region_coords, get_region_coords_by_multi_imgs, click_region, wait_region, scroll_specific_length
...
if __name__ == '__main__':
    ...
    coords_manager = CheckAllTasksCoordsManager(main_region_coords, resolution=resolution)
